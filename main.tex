...
\end{tabular}$$
	...
	\item \textbf{Stap 1} \\ \\
		...
		$$\begin{tabular}{lllll}
$m ^{(0)}$  & $=$ & $(x-\beta ^0)$                        &$=$   & $x+1$                                                           \\
$m ^{(1)}$  & $=$ & $(x-\beta ^1)(x-\beta ^4)$           &$=$   & $x^2 + (\alpha ^2 + \alpha + 1)x + (\alpha ^3 + \alpha ^2 + 1)$ \\
...
101011                 & $\{101011,101010,101001,101111,\textcolor{blue}{100011},111011,001011\}$  \\
...
\end{tabular}$$	
	$r_p$ is duidelijk gelijk aan $1$ want als we \textcolor{blue}{100011} en \textcolor{green}{100100} allebei nog één bit laten afwijken dan zijn ze gelijk aan elkaar.\\ \\
